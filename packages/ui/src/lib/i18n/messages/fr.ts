...
export const dict = {
  ...
  'chat.a2ui.unsupportedComponent': 'Composant non pris en charge : {component}',
  'chat.a2ui.result.title': 'Résultat de {action}',
  'chat.a2ui.result.copy': 'Copier le résultat',
  'chat.a2ui.result.copied': 'Copié',
  'chat.a2ui.error.invalid': "Ce bloc interactif n'a pas pu être affiché",
  'chat.a2ui.error.unsupportedVersion': "Ce bloc interactif utilise A2UI {version}, qu'OpenChamber n'affiche pas",
  'chat.a2ui.error.tooLarge': 'Ce bloc interactif est trop volumineux pour être affiché',
