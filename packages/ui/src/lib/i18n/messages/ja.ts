...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.a2ui.unsupportedComponent': 'サポートされていないコンポーネント: {component}',
  'chat.a2ui.result.title': '{action} の結果',
  'chat.a2ui.result.copy': '結果をコピー',
  'chat.a2ui.result.copied': 'コピーしました',
  'chat.a2ui.error.invalid': 'このインタラクティブブロックを表示できませんでした',
  'chat.a2ui.error.unsupportedVersion': 'このインタラクティブブロックは A2UI {version} を使用しており、OpenChamber では表示できません',
  'chat.a2ui.error.tooLarge': 'このインタラクティブブロックは大きすぎて表示できません',
