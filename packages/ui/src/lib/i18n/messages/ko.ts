...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.a2ui.unsupportedComponent': '지원하지 않는 구성 요소: {component}',
  'chat.a2ui.result.title': '{action} 결과',
  'chat.a2ui.result.copy': '결과 복사',
  'chat.a2ui.result.copied': '복사됨',
  'chat.a2ui.error.invalid': '이 대화형 블록을 표시할 수 없습니다',
  'chat.a2ui.error.unsupportedVersion': '이 대화형 블록은 OpenChamber가 렌더링하지 않는 A2UI {version}을 사용합니다',
  'chat.a2ui.error.tooLarge': '이 대화형 블록은 너무 커서 표시할 수 없습니다',
