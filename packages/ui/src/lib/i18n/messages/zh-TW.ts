...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.a2ui.unsupportedComponent': '不支援的元件：{component}',
  'chat.a2ui.result.title': '{action} 的結果',
  'chat.a2ui.result.copy': '複製結果',
  'chat.a2ui.result.copied': '已複製',
  'chat.a2ui.error.invalid': '無法顯示此互動區塊',
  'chat.a2ui.error.unsupportedVersion': '此互動區塊使用 A2UI {version}，OpenChamber 無法轉譯',
  'chat.a2ui.error.tooLarge': '此互動區塊過大，無法顯示',
