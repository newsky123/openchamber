...
export const dict = {
  ...
  'chat.a2ui.unsupportedComponent': 'Unsupported component: {component}',
  'chat.a2ui.result.title': 'Result of {action}',
  'chat.a2ui.result.copy': 'Copy result',
  'chat.a2ui.result.copied': 'Copied',
  'chat.a2ui.error.invalid': 'This interactive block could not be displayed',
  'chat.a2ui.error.unsupportedVersion': 'This interactive block uses A2UI {version}, which OpenChamber does not render',
  'chat.a2ui.error.tooLarge': 'This interactive block is too large to display',
