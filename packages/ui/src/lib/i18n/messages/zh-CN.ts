...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.a2ui.unsupportedComponent': '不支持的组件：{component}',
  'chat.a2ui.result.title': '{action} 的结果',
  'chat.a2ui.result.copy': '复制结果',
  'chat.a2ui.result.copied': '已复制',
  'chat.a2ui.error.invalid': '无法显示该交互块',
  'chat.a2ui.error.unsupportedVersion': '该交互块使用 A2UI {version}，OpenChamber 无法渲染',
  'chat.a2ui.error.tooLarge': '该交互块过大，无法显示',
